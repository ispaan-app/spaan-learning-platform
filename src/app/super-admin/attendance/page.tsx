...
export default function SuperAdminAttendancePage() {
  ...
  const exportAttendanceData = () => {
    ...
    a.href = url
    a.download = `platform-attendance-records-${format(new Date(), 'yyyy-MM-dd')}.csv`
    a.click()
    window.URL.revokeObjectURL(url)
  }

  if (loading && records.length === 0) {
    return <PageLoader message="Loading platform attendance data..." />
  }
        ...
        <div className="relative max-w-7xl mx-auto space-y-8 p-6">
          ...
          <div className="text-center space-y-6 mb-8">
            <div className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white shadow-lg mb-4">
              ...
              <span className="font-semibold">Super Admin - Attendance Overview</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-900 via-purple-800 to-indigo-800 bg-clip-text text-transparent mb-4">
              Platform-Wide Attendance Analytics
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Comprehensive attendance oversight across all learners, programs, and placements with advanced analytics and reporting.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="relative overflow-hidden bg-white/90 backdrop-blur-sm border-2 border-purple-200 shadow-xl rounded-2xl">
                ...
                <CardContent className="relative p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Platform Records</p>
              ...
              <Card className="relative overflow-hidden bg-white/90 backdrop-blur-sm border-2 border-blue-200 shadow-xl rounded-2xl">
                ...
                <CardContent className="relative p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Platform Rate</p>
              ...
              <Card className="relative overflow-hidden bg-white/90 backdrop-blur-sm border-2 border-orange-200 shadow-xl rounded-2xl">
                ...
                <CardContent className="relative p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Perfect Records</p>
                      <p className="text-3xl font-bold text-gray-900">{stats.perfectAttendance}</p>
                      <p className="text-xs text-gray-500 mt-1">8+ hour days</p>
                    </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <Input
                      ...
                      className="rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-300"
                    />
                    <Input
                      type="date"
          ...
          {/* Platform Attendance Records Table */}
          <Card className="relative overflow-hidden bg-white/90 backdrop-blur-sm border-2 border-gray-200 shadow-xl rounded-2xl">
            <CardHeader className="bg-gradient-to-r from-purple-50 to-indigo-50 border-b border-gray-200">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <span className="text-2xl font-bold bg-gradient-to-r from-gray-800 to-purple-800 bg-clip-text text-transparent">
                      Platform Attendance Records
                    </span>
                    <p className="text-sm text-gray-600 mt-1">
                      {totalRecords} record{totalRecords !== 1 ? 's' : ''} across all programs
                    </p>
                  </div>
                </div>
              </CardTitle>
