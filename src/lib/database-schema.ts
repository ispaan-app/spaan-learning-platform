  ...
  collections: {
    ...
    applications: {
      fields: {
        ...
        reviewNotes: { type: 'string', required: false, maxLength: 1000 },
    ...
    learners: {
      fields: {
        ...
        placement: { type: 'object', required: false },
    ...
    companies: {
      fields: {
        ...
        size: { type: 'string', required: true, enum: ['startup', 'small', 'medium', 'large', 'enterprise'] },
    ...
    documents: {
      fields: {
        id: { type: 'string', required: true, unique: true },
        userId: { type: 'reference', required: true },
        applicationId: { type: 'reference', required: false },
        name: { type: 'string', required: true, maxLength: 200 },
    ...
    notifications: {
      fields: {
        ...
        priority: { type: 'string', required: true, enum: ['low', 'medium', 'high', 'urgent'] },
        category: { type: 'string', required: false, maxLength: 100 },
        actionUrl: { type: 'string', required: false, maxLength: 500 },
    ...
    issueReports: {
      fields: {
        ...
        contactMethod: { type: 'string', required: false, enum: ['email', 'phone', 'sms'] },
        contactInfo: { type: 'string', required: true, maxLength: 200 },
        placementInfo: { type: 'object', required: false },
        deviceInfo: { type: 'object', required: false },
        assignedTo: { type: 'string', required: false },
        resolvedAt: { type: 'date', required: false },
        resolution: { type: 'string', required: false, maxLength: 1000 },
        adminNotes: { type: 'string', required: false, maxLength: 1000 },
        attachments: { type: 'array', required: false },
        comments: { type: 'array', required: false },
        createdAt: { type: 'date', required: true },
        updatedAt: { type: 'date', required: true },
    ...
    auditLogs: {
      fields: {
        ...
        oldValues: { type: 'object', required: false },
        newValues: { type: 'object', required: false },
        ipAddress: { type: 'string', required: false, maxLength: 45 },
