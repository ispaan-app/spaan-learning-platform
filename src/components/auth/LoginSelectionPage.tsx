  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #F5F0E1 0%, #F5F0E1 50%, #F5F0E1 100%)' }}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full blur-3xl animate-pulse" style={{ background: 'linear-gradient(135deg, rgba(59, 130, 246, 0.15) 0%, rgba(147, 51, 234, 0.15) 100%)' }}></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full blur-3xl animate-pulse delay-1000" style={{ background: 'linear-gradient(45deg, rgba(147, 51, 234, 0.15) 0%, rgba(236, 72, 153, 0.15) 100%)' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full blur-3xl animate-pulse delay-500" style={{ background: 'linear-gradient(90deg, rgba(6, 182, 212, 0.08) 0%, rgba(59, 130, 246, 0.08) 100%)' }}></div>
      </div>
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-6xl">
          ...
          <div className="text-center mb-8 md:mb-12">
            ...
            <div className="inline-flex items-center px-4 py-2 md:px-6 md:py-3 rounded-full mb-4 md:mb-6 shadow-lg border" style={{ background: 'rgba(59, 130, 246, 0.1)', borderColor: 'rgba(59, 130, 246, 0.2)' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12">
            ...
            <div className="relative group">
              <div className="absolute -inset-1 rounded-2xl md:rounded-3xl opacity-50 group-hover:opacity-70 transition duration-300" style={{ background: 'rgba(59, 130, 246, 0.1)' }}></div>
              
              <div className="relative rounded-2xl md:rounded-3xl shadow-2xl p-6 md:p-8 border" style={{ background: 'rgba(245, 240, 225, 0.9)', backdropFilter: 'blur(10px)', borderColor: 'rgba(245, 240, 225, 0.3)' }}>
                ...
                <Button asChild className="w-full group/btn inline-flex items-center justify-center px-4 py-3 md:px-6 text-white rounded-xl font-semibold text-sm md:text-base transition-all duration-300 hover:shadow-lg" style={{ backgroundColor: '#3B82F6' }}>
            ...
            {/* Admin Login */}
            <div className="relative group">
              <div className="absolute -inset-1 rounded-2xl md:rounded-3xl opacity-50 group-hover:opacity-70 transition duration-300" style={{ background: 'rgba(147, 51, 234, 0.1)' }}></div>
              ...
              <div className="relative rounded-2xl md:rounded-3xl shadow-2xl p-6 md:p-8 border" style={{ background: 'rgba(245, 240, 225, 0.9)', backdropFilter: 'blur(10px)', borderColor: 'rgba(245, 240, 225, 0.3)' }}>
                ...
                <Button asChild className="w-full group/btn inline-flex items-center justify-center px-4 py-3 md:px-6 text-white rounded-xl font-semibold text-sm md:text-base transition-all duration-300 hover:shadow-lg" style={{ backgroundColor: '#8B5CF6' }}>
          ...
          <div className="text-center mt-8 md:mt-12">
            <div className="relative group">
              <div className="absolute -inset-1 rounded-2xl md:rounded-3xl opacity-50 group-hover:opacity-70 transition duration-300" style={{ background: 'rgba(16, 185, 129, 0.1)' }}></div>
              ...
              <div className="relative rounded-2xl md:rounded-3xl shadow-2xl p-6 md:p-8 border" style={{ background: 'rgba(245, 240, 225, 0.9)', backdropFilter: 'blur(10px)', borderColor: 'rgba(245, 240, 225, 0.3)' }}>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button asChild className="group inline-flex items-center px-6 py-3 md:px-8 md:py-4 text-white rounded-xl font-semibold text-sm md:text-lg transition-all duration-300 hover:shadow-lg" style={{ backgroundColor: '#10B981' }}>
