...
interface LearnerDistributionChartProps {
  data: LearnerDistributionData[]
}

export function LearnerDistributionChart({ data }: LearnerDistributionChartProps) {
  const colors = [
    '#3B82F6', // Blue
    '#10B981', // Green
    '#F59E0B', // Yellow
    ...
    return (
      <div className="h-64 flex items-center justify-center text-gray-500">
        <div className="text-center">
          <p className="text-sm">No learner distribution data available</p>
        </div>
      </div>
    )
  }
